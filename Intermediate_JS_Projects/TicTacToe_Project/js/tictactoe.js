...
let activePlayer = "X";
//this array stores any array of moves. we use this to determine win conditions.
let selectedSquares = [];
...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === "X") {
            //if activePlayer is equal to "X", the duck.gif is placed in HTML
            select.style.backgroundImage = "url('images/oregon-ducks.gif')";
            //active player may only be "X" or "O" so, if not "X" it must be "O"
        } else {
            //if activePLayer is equal to "O", the beaver.png is placed in the HTML
            select.style.backgroundImage = "url('images/osu_beaver.png')";
        }
        //squareNumber and activePlayer are concacated together and added to array
    ...
    //this function results in a random square being slected.
...
//drawWinLine function is called to draw line if condition in met
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        x2 = coordX2,
        //this indicates where the end of a lines y axis is
        y2 = coordY2,
    ...
    function animateLineDrawing() {
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (x < x2) { x += 10; }
            //this condition adds 10 to the previous end 7 point
            if (y < y2) { y += 10; }
