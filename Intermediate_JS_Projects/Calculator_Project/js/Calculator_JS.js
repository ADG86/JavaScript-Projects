...
function Handle_Operator(Next_Operator) {
    ...
    //checks is an operator already exists and if Wait_Second_Operand is true, then updates the operator and exits the function
    ...
    if (First_Operand == null) {
        ...
        //object and the function that matches the operator is executor
...
keys.addEventListener("click", (event) => {
    ...
    //ensures that AC clears the numbres from the Calculator
